...
class Max6651(object):
    ...
    def __init__(self, addr_raw, full_on_raw, tach_overflow_raw):
        ...
        self.tach_prescaler_bits = self.calc_prescale(self.max_rps)
        ...
        # read for debug
        #i2c.writeto(self.addr, config_cmd)
        #config_reg = i2c.readfrom(self.addr, 1) 
    ...
    def calc_prescale(self, max_rps):
        # calculate ideal prescaler value for closed loop operation (target = 0d64)
        # equation 1 on pg 21 
        prescale_dict = {1 : 0b000 , 2 : 0b001 , 4 : 0b010 , 8 : 0b011 , 16 : 0b100}
        tach_prescaler_tmp = max_rps * 64 / 992 
...
# pin x2 comnected to max6651 gpio 0 for tach count overflow
